...
public class UserGeral extends Administrador {
    ...
    public UserGeral(String login, String senha, List<Administrador> administradores, 
        ...
        super(login, senha, administradores, assistentesAdministrativos, 
                dentistas, assistentesDentistas, recepcionistas, clientes, 
                salario, cargaHoraria, cargo, nome, sobrenome, endereco, email, 
