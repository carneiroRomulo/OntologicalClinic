...
public class AssistenteAdministrativo extends Administrador {
    ...
    public AssistenteAdministrativo(List<Administrador> administradores, 
        ...
        super(administradores, assistentesAdministrativos, dentistas, 
                ...
                cargaHoraria, cargo, nome, sobrenome, endereco, email, CPF, 
                RG, telefone, dataNascimento, login, senha);
    }
}
