...
public class Cliente extends Pessoa{
    ...
    public Cliente(boolean pago, int diaPagamento, int mesPagamento, int anoPagamento, String nome, String sobrenome, String endereco, String email, String CPF, String RG, String telefone, int idade) {
