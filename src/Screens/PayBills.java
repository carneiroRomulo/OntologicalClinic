...
public class PayBills extends JFrame{
    JLabel pageLabel = new JLabel("PAGAMENTO DE CONTAS");
    JButton backButton = new JButton("Voltar");

    public PayBills() {
        pageLabel.setBounds(315, 40, 200, 20);
        add(pageLabel); // adiciona o pageLabel ao JFrame
        
        ValidateBills handler = new ValidateBills();
    ...
    private class ValidateBills implements ActionListener {
        @Override
